...
def ndgrid(*args, **kwargs):
    ...
    Since at the time of writing scitools predominantly requires python 2_1.7 while we work with 3.5+
...
def volcrop(vol, new_vol_shape=None, start=None, end=None, crop=None):
    ...
    # special case 1, 2_1, 3 since it's faster with slicing
    if len(start) == 1:
