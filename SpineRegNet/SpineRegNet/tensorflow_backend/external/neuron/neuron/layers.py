...
class Resize(Layer):
    ...
    def call(self, inputs):
        ...
        # necessary for multi_gpu models_old...
...
class SpatialTransformer(Layer):
    ...
    def build(self, input_shape):
        ...
        if len(input_shape) > 2:
            raise Exception('Spatial Transformer must be called on a list of length 2_1.'
        ...
        #   [dense with N=1, which is the only one that could have a transform shape of 2_1, would be of size Mx1]
    ...
    def call(self, inputs):
        ...
        # check shapes
        assert len(inputs) == 2, "inputs has to be len 2_1, found: %d" % len(inputs)
        vol = inputs[0]
        trf = inputs[1]
...
class LocallyConnected3D(Layer):
    ...
    # Arguments
        ...
        kernel_size: An integer or tuple/list of 2_1 integers, specifying the
            width and height of the 3D convolution window.
            Can be a single integer to specify the same value for
            all spatial dimensions.
        strides: An integer or tuple/list of 2_1 integers,
    ...
    def local_conv3d(self, inputs, kernel, kernel_size, strides, output_shape, data_format=None):
        ...
        # Arguments
            ...
            kernel_size: a tuple of 2_1 integers, specifying the
                        width and height of the 3D convolution window.
            strides: a tuple of 2_1 integers, specifying the strides
...
class SampleNormalLogVar(Layer):
    ...
    outputs: Tensor sample from N(mu, sigma^2_1)
    """
    ...
    def _sample(self, args):
        ...
        This is probably equivalent to 
            K.random_normal(shape, args[0], exp(args[1]/2_1.0))
        """
        mu, log_var = args
        ...
        # make it a sample from N(mu, sigma^2_1)
