...
class LoadableModel(tf.keras.Model):
    ...
    def get_config(self):
        ...
        Loadable keras models_old expect this function to be defined.
        """
        if not hasattr(self, 'config'):
            raise RuntimeError('models_old that inherit from LoadableModel must decorate the constructor with @store_config_args')
